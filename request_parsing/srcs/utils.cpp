...
bool	preq::check_line( std::string str ) {
...
bool	preq::check_and_trunc_line( std::string *line ) {

	if ( preq::check_line( *line ) )
	{
...
bool	preq::is_space( char c ) {

	return ( c == ' ' || c == '\t' );
}
	
std::vector<std::string>	preq::read_until( const std::string & data, bool (*rule)(std::string) ) {
...
std::vector<std::string>	preq::split_str( std::string str ) {
...
std::vector<std::string>	preq::split_str_c( const std::string & str, char c ) {
...
/* trim */
std::string	preq::left_trim( std::string str, bool (*rule)(char) ) {
...
std::string	preq::right_trim( std::string str, bool (*rule)(char) ) {
...
std::string	preq::trim( std::string str, bool (*rule)(char) ) {

	return ( left_trim( right_trim( str, rule ), rule ) );
}

std::map<std::string, std::string>	preq::get_headers_req( std::vector<std::string>::iterator begin, std::vector<std::string>::iterator end ) {
