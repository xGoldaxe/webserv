...
std::string & data,
void (*print_or_store)(std::vector<std::string>, std::map<std::string, std::string>, std::string, std::string),
size_t max_url_size
) {
	...
	if ( preq::parse_url( parsed_first_line[1], parsed_first_line[1], path_info, query_string, max_url_size ) == false )
		throw HTTPCode400();
